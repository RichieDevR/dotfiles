...
" lua-line configs
" lua require('lualine.evil_lualine')
" lua require('lualine.slanted-gaps')
" lua require('lualine.bubbles')
lua require('lualine.defaultline')
""" Custom Mappings
